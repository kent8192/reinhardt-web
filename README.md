...
cargo install reinhardt-admin-cli --version "0.2.0-rc.7"
...
<!-- reinhardt-version-sync -->
**Current release line:** Reinhardt documentation tracks `0.2.0-rc.7`. From
...
reinhardt = { version = "0.2.0-rc.7", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.7", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.7", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
[dependencies]
# Core components
reinhardt-http = "0.2.0-rc.7"
reinhardt-urls = "0.2.0-rc.7"

# Optional: Database
reinhardt-db = "0.2.0-rc.7"

# Optional: Authentication
reinhardt-auth = "0.2.0-rc.7"

# Optional: REST API features
reinhardt-rest = "0.2.0-rc.7"

# Optional: Admin panel
reinhardt-admin = "0.2.0-rc.7"

# Optional: Advanced features
reinhardt-graphql = "0.2.0-rc.7"
reinhardt-websockets = "0.2.0-rc.7"
```
