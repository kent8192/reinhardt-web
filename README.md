...
<!-- reinhardt-version-sync -->
**Current release line:** Reinhardt documentation tracks `0.4.0-alpha.2`. From
...
reinhardt = { version = "0.4.0-alpha.2", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.2", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.2", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
reinhardt-urls = "0.4.0-alpha.2"

# Optional: Database
reinhardt-db = "0.4.0-alpha.2"

# Optional: Authentication
reinhardt-auth = "0.4.0-alpha.2"

# Optional: REST API features
reinhardt-rest = "0.4.0-alpha.2"

# Optional: Admin panel
reinhardt-admin = "0.4.0-alpha.2"

# Optional: Advanced features
reinhardt-graphql = "0.4.0-alpha.2"
reinhardt-websockets = "0.4.0-alpha.2"
```
...
```bash
reinhardt-admin startproject my-api \
  --reinhardt-version "0.4.0-alpha.2" \
