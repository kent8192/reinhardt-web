...
<!-- reinhardt-version-sync -->
**Current release line:** Reinhardt documentation tracks `0.3.0-rc.3`. From
...
reinhardt = { version = "0.3.0-rc.3", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.3.0-rc.3", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.3.0-rc.3", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
[dependencies]
# Core components
reinhardt-http = "0.3.0-rc.3"
reinhardt-urls = "0.3.0-rc.3"

# Optional: Database
reinhardt-db = "0.3.0-rc.3"

# Optional: Authentication
reinhardt-auth = "0.3.0-rc.3"

# Optional: REST API features
reinhardt-rest = "0.3.0-rc.3"

# Optional: Admin panel
reinhardt-admin = "0.3.0-rc.3"

# Optional: Advanced features
reinhardt-graphql = "0.3.0-rc.3"
reinhardt-websockets = "0.3.0-rc.3"
```
