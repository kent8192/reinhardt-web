...
<!-- reinhardt-version-sync -->
**Current release line:** Reinhardt documentation tracks `0.4.0-alpha.9`. From
...
reinhardt = { version = "0.4.0-alpha.9", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.9", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.9", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
[dependencies]
# Core components
reinhardt-http = "0.4.0-alpha.9"
reinhardt-urls = "0.4.0-alpha.9"

# Optional: Database
reinhardt-db = "0.4.0-alpha.9"

# Optional: Authentication
reinhardt-auth = "0.4.0-alpha.9"

# Optional: REST API features
reinhardt-rest = "0.4.0-alpha.9"

# Optional: Admin panel
reinhardt-admin = "0.4.0-alpha.9"

# Optional: Advanced features
reinhardt-graphql = "0.4.0-alpha.9"
reinhardt-websockets = "0.4.0-alpha.9"
```
...
```bash
reinhardt-admin startproject my-api \
  --reinhardt-version "0.4.0-alpha.9" \
