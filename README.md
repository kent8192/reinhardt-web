...
<!-- reinhardt-version-sync -->
**Current status:** All crates are at `0.1.0-rc.26` (Release Candidate).
...
reinhardt = { version = "0.1.0-rc.26", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.1.0-rc.26", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.1.0-rc.26", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
[dependencies]
# Core components
reinhardt-http = "0.1.0-rc.26"
reinhardt-urls = "0.1.0-rc.26"

# Optional: Database
reinhardt-db = "0.1.0-rc.26"

# Optional: Authentication
reinhardt-auth = "0.1.0-rc.26"

# Optional: REST API features
reinhardt-rest = "0.1.0-rc.26"

# Optional: Admin panel
reinhardt-admin = "0.1.0-rc.26"

# Optional: Advanced features
reinhardt-graphql = "0.1.0-rc.26"
reinhardt-websockets = "0.1.0-rc.26"
```
