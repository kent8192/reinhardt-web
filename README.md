...
```bash
# Currently a pre-release: --version is required. Once 0.2.0-rc.5 stable ships,
...
**Current status:** Reinhardt is at `0.2.0-rc.5`. From `0.1.0` onward, all
...
reinhardt = { version = "0.2.0-rc.5", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.5", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.5", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
[dependencies]
# Core components
reinhardt-http = "0.2.0-rc.5"
reinhardt-urls = "0.2.0-rc.5"

# Optional: Database
reinhardt-db = "0.2.0-rc.5"

# Optional: Authentication
reinhardt-auth = "0.2.0-rc.5"

# Optional: REST API features
reinhardt-rest = "0.2.0-rc.5"

# Optional: Admin panel
reinhardt-admin = "0.2.0-rc.5"

# Optional: Advanced features
reinhardt-graphql = "0.2.0-rc.5"
reinhardt-websockets = "0.2.0-rc.5"
```
