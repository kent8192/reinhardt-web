...
<!-- reinhardt-version-sync -->
**Current release line:** Reinhardt documentation tracks `0.4.0-alpha.15`. From
...
reinhardt = { version = "0.4.0-alpha.15", package = "reinhardt-web" }
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.15", package = "reinhardt-web", default-features = false, features = ["full"] }
```
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.15", package = "reinhardt-web", default-features = false, features = ["minimal"] }
```
...
[dependencies]
# Core components
reinhardt-http = "0.4.0-alpha.15"
reinhardt-urls = "0.4.0-alpha.15"

# Optional: Database
reinhardt-db = "0.4.0-alpha.15"

# Optional: Authentication
reinhardt-auth = "0.4.0-alpha.15"

# Optional: browser-bound social OAuth state (add `session-redis` for Redis)
reinhardt = { version = "0.4.0-alpha.15", package = "reinhardt-web", default-features = false, features = ["social-auth"] }

# Optional: REST API features
reinhardt-rest = "0.4.0-alpha.15"

# Optional: Admin panel
reinhardt-admin = "0.4.0-alpha.15"

# Optional: Advanced features
reinhardt-graphql = "0.4.0-alpha.15"
reinhardt-websockets = "0.4.0-alpha.15"
```
...
```bash
reinhardt-admin startproject my-api \
  --reinhardt-version "0.4.0-alpha.15" \
