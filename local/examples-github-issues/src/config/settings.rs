...
pub fn get_settings() -> Settings {
	...
	let merged = SettingsBuilder::new()
        ...
        .add_source(
            DefaultSource::new()
                // Core settings
                .with_value("base_dir", serde_json::Value::String(base_dir.to_string_lossy().to_string()))
                .with_value("secret_key", serde_json::Value::String("test-secret-key-for-development-only".to_string()))
