...
<template>
  ...
  >
    ...
    <section data-benchmark-scenario="router">
      <nav>
        <button data-benchmark-action="route-home" @click="route = 'home'">Home</button>
        <button data-benchmark-action="route-detail" @click="route = 'detail'">Detail</button>
        <button data-benchmark-action="route-form" @click="route = 'form'">Form</button>
      </nav>
    ...
    <section data-benchmark-scenario="keyed-list">
      ...
      <ul>
        <li v-for="row in rows.slice(0, 25)" :key="row.id">{{ row.label }}</li>
      </ul>
    </section>
  </main>
</template>
