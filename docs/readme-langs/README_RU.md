...
- 🌐 [Официальный сайт](https://reinhardt-web.dev) - Документация, учебники и руководства
- 🚀 [Быстрый старт](#быстрый-старт) - Запуск за 5 минут
- 📦 [Варианты установки](#установка) - Выберите свой вариант: Micro, Standard или Full
- 📚 [Руководство по началу работы](https://reinhardt-web.dev/quickstart/getting-started/) - Пошаговое руководство
- 🎛️ [Флаги функций](https://reinhardt-web.dev/docs/feature-flags/) - Тонкая настройка сборки
...
Полный список см. в [Доступные компоненты](#доступные-компоненты), примеры в [Руководстве по началу работы](https://reinhardt-web.dev/quickstart/getting-started/).
...
**📖 Полный список доступных крейтов и флагов функций см. в [Руководстве по флагам функций](https://reinhardt-web.dev/docs/feature-flags/).**
...
Полный список см. в [Руководстве по флагам функций](https://reinhardt-web.dev/docs/feature-flags/).

Полное пошаговое руководство см. в [Руководстве по началу работы](https://reinhardt-web.dev/quickstart/getting-started/).
...
См. [Документацию по настройкам](docs/SETTINGS_DOCUMENT.md) для деталей.
...
Полный список атрибутов полей см. в [Руководстве по атрибутам полей](docs/field_attributes.md).
...
**Детальные флаги функций в каждом крейте см. в [Руководстве по флагам функций](https://reinhardt-web.dev/docs/feature-flags/).**

---

## Документация

- 📚 [Руководство по началу работы](https://reinhardt-web.dev/quickstart/getting-started/) - Пошаговое руководство для начинающих
- 🎛️ [Руководство по флагам функций](https://reinhardt-web.dev/docs/feature-flags/) - Оптимизация сборки с гранулярным контролем функций
- 📖 [Справочник API](https://docs.rs/reinhardt) (Скоро)
- 📝 [Учебники](https://reinhardt-web.dev/quickstart/tutorials/) - Обучение на реальных приложениях
...
- 💭 **GitHub Discussions**: [Задавайте вопросы и делитесь идеями](https://github.com/kent8192/reinhardt-web/discussions)
- 🐛 **Issues**: [Сообщайте об ошибках](https://github.com/kent8192/reinhardt-web/issues)
- 📖 **Документация**: [Читайте руководства](../)

Перед тем как задать вопрос, проверьте:

- ✅ [Руководство по началу работы](https://reinhardt-web.dev/quickstart/getting-started/)
- ✅ [Примеры](https://github.com/kent8192/reinhardt-web/tree/main/examples/)
...
Этот проект лицензирован под [BSD 3-Clause License](../../LICENSE).
