...
## [0.1.0-rc.30](https://github.com/kent8192/reinhardt-web/compare/reinhardt-web@v0.1.0-rc.29...reinhardt-web@v0.1.0-rc.30) - 2026-05-17
...
- *(examples-tutorial-basis)* migrate shared/types.rs to #[shared_model]
- *(examples-twitter)* migrate shared/types.rs to #[shared_model]
