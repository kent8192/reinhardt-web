...
- *(examples)* add manage bin alias for tutorial-basis and tutorial-rest
- *(examples)* gitignore generated migrations/ in tutorial examples
- *(examples)* untrack previously-committed generated migration snippets
