...
## [0.2.0-rc.2](https://github.com/kent8192/reinhardt-web/compare/reinhardt-web@v0.1.2...reinhardt-web@v0.2.0-rc.2) - 2026-05-28
...
- *(features)* include rest facade feature in api preset
- *(examples)* pin reinhardt to 0.2.0-rc.2 for develop branch
- *(examples)* add explicit basename to snippets viewset
...
- apply rustfmt to non-DSL files on develop/0.2.0
- *(examples)* reformat twitter page macros via reinhardt-admin fmt
