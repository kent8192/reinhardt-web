...
## [0.2.0-rc.2](https://github.com/kent8192/reinhardt-web/compare/reinhardt-web@v0.1.2...reinhardt-web@v0.2.0-rc.2) - 2026-05-30
...
- *(examples)* add ContactSettings fragment to satisfy HasCommonSettings
...
- *(examples)* apply reinhardt-admin formatter to drifted files
