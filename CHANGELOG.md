...
## [0.1.0-alpha.16](https://github.com/kent8192/reinhardt-web/compare/reinhardt-web@v0.1.0-alpha.15...reinhardt-web@v0.1.0-alpha.16) - 2026-02-19
...
- *(ci)* remove push trigger from main branch
...
- *(pages)* fix rustfmt formatting in renderer.rs
