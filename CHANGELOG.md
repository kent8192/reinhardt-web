...
## [0.1.3](https://github.com/kent8192/reinhardt-web/compare/reinhardt-web@v0.1.2...reinhardt-web@v0.1.3) - 2026-05-28

### Changed

- *(examples)* return Result<User, SessionError> from session_user_factory
- *(examples)* rename UserManager to AuthUserManager
