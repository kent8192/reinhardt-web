...
- **README.md**: プロジェクトレベルの概要（英語）
- **README.ja.md**: プロジェクトレベルの概要（日本語）
- **クレート README.md**: 個別クレートのドキュメント（英語）
- **クレート README.ja.md**: 個別クレートのドキュメント（日本語）
- **docs/** ディレクトリ: 詳細なガイドとチュートリアル

### ドキュメントの同期

- 英語と日本語のドキュメントを同期
- `README.md` と `README.ja.md` の両方を更新
