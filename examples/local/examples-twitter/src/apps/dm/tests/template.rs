//! Tests for dm
//!
//! This module contains example tests for the dm RESTful API application.
...
mod tests {
    ...
    fn test_viewset_list_action() {
        ...
        // let response = client.get("/api/dm/").await;
    ...
    fn test_viewset_create_action() {
        ...
        // let response = client.post("/api/dm/", payload).await;
    ...
    fn test_api_authentication() {
        ...
        // Example:
        // let client = APIClient::new();
        // let response = client.get("/api/dm/protected/").await;
