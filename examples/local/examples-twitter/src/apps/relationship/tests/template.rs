...
//!
//! This module contains example tests for the relationship RESTful API application.
...
mod tests {
    ...
    fn test_viewset_list_action() {
        ...
        // let response = client.get("/api/relationship/").await;
    ...
    fn test_viewset_create_action() {
        ...
        // let response = client.post("/api/relationship/", payload).await;
    ...
    fn test_api_authentication() {
        ...
        // Example:
        // let client = APIClient::new();
        // let response = client.get("/api/relationship/protected/").await;
