//! Tests for profile
//!
//! This module contains example tests for the profile RESTful API application.
...
mod tests {
    ...
    fn test_viewset_list_action() {
        ...
        // let response = client.get("/api/profile/").await;
    ...
    fn test_viewset_create_action() {
        ...
        // let response = client.post("/api/profile/", payload).await;
    ...
    fn test_api_authentication() {
        ...
        // Example:
        // let client = APIClient::new();
        // let response = client.get("/api/profile/protected/").await;
