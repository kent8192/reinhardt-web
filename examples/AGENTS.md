...
reinhardt = { path = "..", version = "0.4.0-alpha.15", package = "reinhardt-web" }
```
...
reinhardt = { version = "0.4.0-alpha.15", package = "reinhardt-web", features = ["core", "database"] }
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.15", package = "reinhardt-web", features = ["core"] }
