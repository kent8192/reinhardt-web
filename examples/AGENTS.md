...
reinhardt = { path = "..", version = "0.3.0-rc.5", package = "reinhardt-web" }
```
...
reinhardt = { version = "0.3.0-rc.5", package = "reinhardt-web", features = ["core", "database"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.0-rc.5", package = "reinhardt-web", features = ["core"] }
