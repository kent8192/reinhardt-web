...
reinhardt = { path = "..", version = "0.3.20", package = "reinhardt-web" }
```
...
reinhardt = { version = "0.3.20", package = "reinhardt-web", features = ["core", "database"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.20", package = "reinhardt-web", features = ["core"] }
