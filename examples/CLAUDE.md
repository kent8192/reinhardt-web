...
reinhardt = { path = "..", version = "0.2.0-rc.3", package = "reinhardt-web" }
```
...
reinhardt = { version = "0.2.0-rc.3", package = "reinhardt-web", features = ["core", "database"] }
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.3", package = "reinhardt-web", features = ["core"] }
