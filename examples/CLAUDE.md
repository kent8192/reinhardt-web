...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.1", package = "reinhardt-web", features = ["standard"] }
```
...
reinhardt = { version = "0.2.0-rc.1", package = "reinhardt-web", features = ["core", "database"] }
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.1", package = "reinhardt-web", features = ["core"] }
