...
pub fn build_openapi_schema() -> OpenApiSchema {
    ...
    generator.generate().expect("Failed to generate OpenAPI schema")
}
...
fn register_auth_schemas(generator: &mut SchemaGenerator) {
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("username", Schema::string()), ("email", Schema::string()),
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("id", Schema::string()), ("username", Schema::string()), ("email",
                    Schema::string()),
                ],
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("access_token", Schema::string()), ("user",
                    Schema::object_with_properties(vec![("id", Schema::string()),
                    ("username", Schema::string()), ("email", Schema::string()),],
                    vec!["id", "username", "email"],),),
                ],
...
fn register_profile_schemas(generator: &mut SchemaGenerator) {
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("user_id", Schema::string()), ("bio", Schema::string()),
                    ("location", Schema::string()), ("avatar_url", Schema::string()),
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("bio", Schema::string()), ("location", Schema::string()),
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("followers",
                    Schema::array(Schema::object_with_properties(vec![("user_id",
                    Schema::string()), ("username", Schema::string()), ("created_at",
                    Schema::datetime()),], vec!["user_id", "username"],)),), ("count",
                    Schema::integer()),
                ],
                vec!["followers", "count"],
                "List of followers",
...
fn register_dm_schemas(generator: &mut SchemaGenerator) {
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("id", Schema::string()), ("participants",
                    Schema::array(Schema::string())), ("created_at", Schema::datetime()),
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("id", Schema::string()), ("room_id", Schema::string()),
                    ("sender_id", Schema::string()), ("content", Schema::string()),
                    ("created_at", Schema::datetime()),
                ],
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("rooms", Schema::array(Schema::object_with_properties(vec![("id",
                    Schema::string()), ("participants", Schema::array(Schema::string())),
                    ("created_at", Schema::datetime()), ("updated_at",
                    Schema::datetime()),], vec!["id", "participants", "created_at"],)),),
    ...
    registry
        .register(
            ...
            Schema::object_with_description(
                vec![
                    ("messages", Schema::array(Schema::object_with_properties(vec![("id",
                    Schema::string()), ("room_id", Schema::string()), ("sender_id",
                    Schema::string()), ("content", Schema::string()), ("created_at",
                    Schema::datetime()),], vec!["id", "room_id", "sender_id", "content",
                    "created_at"],)),), ("count", Schema::integer()),
                ],
                vec!["messages", "count"],
