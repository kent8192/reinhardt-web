...
pub fn error_circle_icon() -> Page {
	page!(
		|| { svg { class : "w-5 h-5 flex-shrink-0", fill : "currentColor", viewBox :
		"0 0 20 20", path { fill_rule : "evenodd", d :
...
pub fn error_circle_icon_with_class(class: &str) -> Page {
	...
	page!(
		| class : String | { svg { class : class, fill : "currentColor", viewBox :
		"0 0 20 20", path { fill_rule : "evenodd", d :
		"M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z",
		} } }
	)(class)
...
pub fn close_icon() -> Page {
	page!(
		|| { svg { class : "w-4 h-4", fill : "none", stroke : "currentColor", viewBox :
		"0 0 24 24", path { stroke_linecap : "round", stroke_linejoin : "round",
		stroke_width : "2", d : "M6 18L18 6M6 6l12 12", } } }
	)()
}
...
pub fn warning_icon() -> Page {
	page!(
		|| { svg { class : "w-5 h-5 flex-shrink-0 mt-0.5", fill : "currentColor", viewBox
		: "0 0 20 20", path { fill_rule : "evenodd", d :
...
pub fn search_icon() -> Page {
	page!(
		|| { svg { class : "w-6 h-6", fill : "none", stroke : "currentColor", viewBox :
		"0 0 24 24", path { stroke_linecap : "round", stroke_linejoin : "round",
		stroke_width : "2", d : "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z", } } }
	)()
}
...
pub fn plus_icon() -> Page {
	page!(
		|| { svg { class : "w-6 h-6", fill : "none", stroke : "currentColor", viewBox :
		"0 0 24 24", path { stroke_linecap : "round", stroke_linejoin : "round",
		stroke_width : "2", d : "M12 4v16m8-8H4", } } }
	)()
}
...
pub fn chat_bubble_icon() -> Page {
	page!(
		|| { svg { class : "w-5 h-5", fill : "none", stroke : "currentColor", viewBox :
		"0 0 24 24", path { stroke_linecap : "round", stroke_linejoin : "round",
		stroke_width : "1.5", d :
...
pub fn chat_bubble_icon_lg() -> Page {
	page!(
		...
		stroke_linejoin : "round", stroke_width : "1.5", d :
		"M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z",
		} } }
	)()
}
...
pub fn arrow_left_icon() -> Page {
	page!(
		|| { svg { class : "w-5 h-5", fill : "none", stroke : "currentColor", viewBox :
		"0 0 24 24", path { stroke_linecap : "round", stroke_linejoin : "round",
		stroke_width : "2", d : "M10 19l-7-7m0 0l7-7m-7 7h18", } } }
	)()
}
...
pub fn chevron_right_icon() -> Page {
	page!(
		|| { svg { class : "w-5 h-5 text-content-tertiary flex-shrink-0", fill : "none",
		stroke : "currentColor", viewBox : "0 0 24 24", path { stroke_linecap : "round",
		stroke_linejoin : "round", stroke_width : "2", d : "M9 5l7 7-7 7", } } }
	)()
}
...
pub fn heart_icon_filled() -> Page {
	page!(
		|| { svg { class : "w-5 h-5 animate-heart", fill : "currentColor", stroke :
		"currentColor", viewBox : "0 0 24 24", path { stroke_linecap : "round",
		stroke_linejoin : "round", stroke_width : "1.5", d :
		"M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z",
		} } }
