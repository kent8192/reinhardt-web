...
///
/// The argument order matches form! macro's field order: avatar_url, bio,
/// location, website. CSRF is supplied by the `#[server_fn]` client stub
/// through `X-CSRFToken` and verified by middleware.
#[server_fn]
