...
//! Server-only model modules convert into these explicit wire DTOs before data
//! crosses the server-function boundary.
...
/// Public user data returned to the WASM client.
...
/// Public poll question data returned to the WASM client.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Public poll choice data returned to the WASM client.
#[derive(Debug, Clone, Serialize, Deserialize)]
