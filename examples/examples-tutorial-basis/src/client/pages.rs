...
pub fn question_edit_page(question_id: i64) -> Page {
	with_nav(crate::client::components::polls::question_edit(question_id))
}

/// Delete question confirmation page - Author-only deletion
pub fn question_delete_page(question_id: i64) -> Page {
	with_nav(crate::client::components::polls::question_delete_confirm(
		question_id,
	))
}
...
pub fn choice_new_page(question_id: i64) -> Page {
	with_nav(crate::client::components::polls::choice_new(question_id))
}
...
pub fn login_page() -> Page {
	with_nav(crate::client::components::users::login_form())
}
