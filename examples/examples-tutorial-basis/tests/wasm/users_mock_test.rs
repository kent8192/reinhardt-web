...
use examples_tutorial_basis::apps::users::server::models::UserInfo;
...
/// Create a mock UserInfo for testing. Matches the info companion generated by
/// the `#[model]` macro for `src/apps/users/server/models.rs`.
