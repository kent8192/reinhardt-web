...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.15", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.15", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
...
```toml
[dependencies]
reinhardt-grpc = { version = "0.4.0-alpha.15", features = ["di"] }
reinhardt-di = "0.4.0-alpha.15"
```
