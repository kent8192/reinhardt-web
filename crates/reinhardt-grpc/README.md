...
```toml
[dependencies]
reinhardt = { version = "0.3.17", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.17", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
