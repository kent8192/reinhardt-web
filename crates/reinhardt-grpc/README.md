...
```toml
[dependencies]
reinhardt = { version = "0.3.21", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.21", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
