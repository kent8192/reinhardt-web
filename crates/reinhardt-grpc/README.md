...
```toml
[dependencies]
reinhardt = { version = "0.3.19", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.19", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
