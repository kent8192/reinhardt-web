...
```toml
[dependencies]
reinhardt = { version = "0.3.18", features = ["grpc"] }
...
```toml
[dependencies]
reinhardt = { version = "0.3.18", package = "reinhardt-web", default-features = false, features = ["minimal", "grpc"] }
```
