...
## [0.1.0-rc.6](https://github.com/kent8192/reinhardt-web/compare/reinhardt-grpc@v0.1.0-rc.4...reinhardt-grpc@v0.1.0-rc.6) - 2026-03-10

### Documentation

- add missing doc comments for public API modules and types
- *(grpc)* add missing public API documentation
