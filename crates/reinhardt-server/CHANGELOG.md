...
## [0.1.0-alpha.8](https://github.com/kent8192/reinhardt-web/compare/reinhardt-server@v0.1.0-alpha.7...reinhardt-server@v0.1.0-alpha.8) - 2026-02-19

### Security

- *(server,core)* add request body size limits and decompression bomb prevention
