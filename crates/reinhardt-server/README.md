...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.6", features = ["server"] }

# For WebSocket support:
# reinhardt = { version = "0.2.0-rc.6", features = ["server", "websocket"] }

# For GraphQL support:
# reinhardt = { version = "0.2.0-rc.6", features = ["server", "graphql"] }
