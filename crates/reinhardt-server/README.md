...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.16", features = ["server"] }

# For WebSocket support:
# reinhardt = { version = "0.4.0-alpha.16", features = ["server", "websocket"] }

# For GraphQL support:
# reinhardt = { version = "0.4.0-alpha.16", features = ["server", "graphql"] }
