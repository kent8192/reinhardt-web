...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.17", features = ["server"] }

# For WebSocket support:
# reinhardt = { version = "0.4.0-alpha.17", features = ["server", "websocket"] }

# For GraphQL support:
# reinhardt = { version = "0.4.0-alpha.17", features = ["server", "graphql"] }
