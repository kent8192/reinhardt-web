...
## [0.1.0-alpha.6](https://github.com/kent8192/reinhardt-web/compare/reinhardt-i18n@v0.1.0-alpha.5...reinhardt-i18n@v0.1.0-alpha.6) - 2026-02-19

### Fixed

- *(i18n)* add plural index validation to prevent memory exhaustion
- *(i18n)* replace mem::forget with proper guard handling ([[#713](https://github.com/kent8192/reinhardt-web/issues/713)](https://github.com/kent8192/reinhardt-web/issues/713))
