...
///
/// ```
/// use crate::filters::geo::{DistanceFilter, DistanceUnit};
/// use geo_types::Point;
///
...
///
/// ```
/// use crate::filters::geo::BoundingBoxFilter;
/// use geo_types::Rect;
///
...
///
/// ```
/// use crate::filters::geo::PolygonFilter;
...
///
/// ```
/// use crate::filters::geo::{NearbyFilter, DistanceUnit};
/// use geo_types::Point;
///
/// let center = Point::new(0.0, 0.0);
...
impl<M> NearbyFilter<M> {
	...
	///
	/// ```
	/// use crate::filters::geo::NearbyFilter;
	/// use geo_types::Point;
	///
