...
//!
//! ```
//! use crate::filters::{QueryOptimizer, OptimizationHint};
//!
//! # async fn example() {
...
///
/// ```
/// use crate::filters::OptimizationHint;
///
...
impl OptimizationHint {
	...
	///
	/// ```
	/// use crate::filters::{OptimizationHint, DatabaseType};
	///
	/// let hint = OptimizationHint::PreferIndexScan;
...
///
/// ```
/// use crate::filters::{FilterBackend, QueryOptimizer, OptimizationHint};
/// use std::collections::HashMap;
///
/// # async fn example() {
/// let optimizer = QueryOptimizer::new()
...
impl QueryOptimizer {
	...
	///
	/// ```
	/// use crate::filters::QueryOptimizer;
	///
	/// let optimizer = QueryOptimizer::new();
	...
	///
	/// ```
	/// use crate::filters::{QueryOptimizer, DatabaseType};
	///
