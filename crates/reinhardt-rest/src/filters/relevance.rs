...
//!
//! ```
//! use crate::filters::{RelevanceScorer, ScoringAlgorithm};
//!
//! # async fn example() {
...
///
/// ```
/// use crate::filters::ScoringAlgorithm;
///
...
///
/// ```
/// use crate::filters::ScoredResult;
///
...
///
/// ```
/// use crate::filters::{FilterBackend, RelevanceScorer, ScoringAlgorithm};
/// use std::collections::HashMap;
///
/// # async fn example() {
/// let scorer = RelevanceScorer::new()
...
impl RelevanceScorer {
	...
	///
	/// ```
	/// use crate::filters::RelevanceScorer;
	///
	/// let scorer = RelevanceScorer::new();
	...
	///
	/// ```
	/// use crate::filters::{RelevanceScorer, FieldBoost};
	///
	/// let boost = FieldBoost::new("title", 2.0);
	/// let scorer = RelevanceScorer::new()
	///     .with_boost(boost);
