...
impl TimeRange {
	...
	///
	/// ```
	/// use crate::throttling::time_of_day::TimeRange;
	///
...
impl TimeOfDayConfig {
	...
	///
	/// ```
	/// use crate::throttling::time_of_day::{TimeOfDayConfig, TimeRange};
	///
...
///
/// ```
/// use crate::throttling::time_of_day::{TimeOfDayThrottle, TimeOfDayConfig, TimeRange};
