...
impl AdaptiveConfig {
	...
	///
	/// ```
	/// use crate::throttling::adaptive::AdaptiveConfig;
	///
...
///
/// ```
/// use crate::throttling::adaptive::{AdaptiveThrottle, AdaptiveConfig};
...
impl<B: ThrottleBackend, T: TimeProvider> AdaptiveThrottle<B, T> {
	...
	///
	/// ```
	/// use crate::throttling::adaptive::{AdaptiveThrottle, AdaptiveConfig, LoadMetrics};
	/// use crate::throttling::{MemoryBackend, Throttle};
	/// use std::sync::Arc;
	///
	/// # tokio_test::block_on(async {
