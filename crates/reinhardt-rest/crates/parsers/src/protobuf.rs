...
mod tests {
    ...
    async fn test_protobuf_parser_larger_message() {
        ...
        let body = Bytes::from(vec![
            ...
            0x12, 0x04, 0x74, 0x65, 0x73, 0x74, // field 2, wire type 2 (length-delimited), length 4, "test"
        ]);
    ...
    async fn test_protobuf_parser_complex_message() {
        ...
        let body = Bytes::from(vec![
            ...
            0x22, 0x09, 0x08, 0x64, 0x12, 0x05, 0x77, 0x6F, 0x72, 0x6C, 0x64, // field 4, nested (length 9)
