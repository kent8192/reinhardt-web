...
///
/// ```
/// use reinhardt_pagination::cursor::{CreatedAtOrdering, OrderingStrategy};
///
...
impl CreatedAtOrdering {
	...
	///
	/// ```
	/// use reinhardt_pagination::cursor::CreatedAtOrdering;
	///
	/// let ordering = CreatedAtOrdering::new();
...
///
/// ```
/// use reinhardt_pagination::cursor::{IdOrdering, OrderingStrategy};
///
...
impl IdOrdering {
	...
	///
	/// ```
	/// use reinhardt_pagination::cursor::IdOrdering;
	///
	/// let ordering = IdOrdering::new();
