...
///
/// ```
/// use reinhardt_pagination::cursor::database::Cursor;
///
...
///
/// ```
/// use reinhardt_pagination::cursor::database::HasTimestamp;
///
/// #[derive(Clone)]
/// struct User {
///     id: i64,
...
impl CursorPaginator {
    ...
    ///
    /// ```
    /// use reinhardt_pagination::cursor::database::CursorPaginator;
    ///
...
///
/// ```
/// use reinhardt_pagination::cursor::database::CursorPaginatedResponse;
///
