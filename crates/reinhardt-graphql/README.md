...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.15", features = ["graphql"] }
...
reinhardt = { version = "0.4.0-alpha.15", features = ["graphql", "di"] }

# With gRPC transport
reinhardt = { version = "0.4.0-alpha.15", features = ["graphql", "grpc"] }
```
