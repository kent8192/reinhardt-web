...
## [0.1.0-alpha.18](https://github.com/kent8192/reinhardt/compare/reinhardt-websockets@v0.1.0-alpha.17...reinhardt-websockets@v0.1.0-alpha.18) - 2026-02-27

### Fixed

- *(auth)* add #[non_exhaustive] to all public error enums
