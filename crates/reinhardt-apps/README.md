...
```toml
[dependencies]
reinhardt = { version = "0.3.0-rc.6", package = "reinhardt-web", features = ["apps"] }

# Or use a preset:
# reinhardt = { version = "0.3.0-rc.6", package = "reinhardt-web", features = ["standard"] }  # Recommended
# reinhardt = { version = "0.3.0-rc.6", package = "reinhardt-web", features = ["full"] }      # All features
```
...
# Cargo.toml
[dependencies]
reinhardt = { version = "0.3.0-rc.6", package = "reinhardt-web", features = ["auth", "admin"] }
```
