...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.2", package = "reinhardt-web", features = ["apps"] }

# Or use a preset:
# reinhardt = { version = "0.4.0-alpha.2", package = "reinhardt-web", features = ["standard"] }  # Recommended
# reinhardt = { version = "0.4.0-alpha.2", package = "reinhardt-web", features = ["full"] }      # All features
```
...
# Cargo.toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.2", package = "reinhardt-web", features = ["auth", "admin"] }
```
