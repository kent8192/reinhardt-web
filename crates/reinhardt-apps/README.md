...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.4", package = "reinhardt-web", features = ["apps"] }

# Or use a preset:
# reinhardt = { version = "0.2.0-rc.4", package = "reinhardt-web", features = ["standard"] }  # Recommended
# reinhardt = { version = "0.2.0-rc.4", package = "reinhardt-web", features = ["full"] }      # All features
```
...
# Cargo.toml
[dependencies]
reinhardt = { version = "0.2.0-rc.4", package = "reinhardt-web", features = ["auth", "admin"] }
```
