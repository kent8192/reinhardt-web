...
///
/// ```
/// use reinhardt_utils::utils_core::dateformat::format;
...
pub mod shortcuts {
	...
	///
	/// ```
	/// use reinhardt_utils::utils_core::dateformat::shortcuts::iso_date;
	/// use chrono::{TimeZone, Utc};
	///
	/// let dt = Utc.with_ymd_and_hms(2025, 1, 15, 14, 30, 45).unwrap();
	...
	///
	/// ```
	/// use reinhardt_utils::utils_core::dateformat::shortcuts::iso_datetime;
	/// use chrono::{TimeZone, Utc};
	///
	/// let dt = Utc.with_ymd_and_hms(2025, 1, 15, 14, 30, 45).unwrap();
	...
	///
	/// ```
	/// use reinhardt_utils::utils_core::dateformat::shortcuts::us_date;
	/// use chrono::{TimeZone, Utc};
	///
	/// let dt = Utc.with_ymd_and_hms(2025, 1, 15, 14, 30, 45).unwrap();
	...
	///
	/// ```
	/// use reinhardt_utils::utils_core::dateformat::shortcuts::eu_date;
	/// use chrono::{TimeZone, Utc};
	///
	/// let dt = Utc.with_ymd_and_hms(2025, 1, 15, 14, 30, 45).unwrap();
	...
	///
	/// ```
	/// use reinhardt_utils::utils_core::dateformat::shortcuts::full_date;
	/// use chrono::{TimeZone, Utc};
	///
	/// let dt = Utc.with_ymd_and_hms(2025, 1, 15, 14, 30, 45).unwrap();
	...
	///
	/// ```
	/// use reinhardt_utils::utils_core::dateformat::shortcuts::short_date;
	/// use chrono::{TimeZone, Utc};
	///
	/// let dt = Utc.with_ymd_and_hms(2025, 1, 15, 14, 30, 45).unwrap();
	...
	///
	/// ```
	/// use reinhardt_utils::utils_core::dateformat::shortcuts::time_24;
	/// use chrono::{TimeZone, Utc};
	///
	/// let dt = Utc.with_ymd_and_hms(2025, 1, 15, 14, 30, 45).unwrap();
	...
	///
	/// ```
	/// use reinhardt_utils::utils_core::dateformat::shortcuts::time_12;
	/// use chrono::{TimeZone, Utc};
	///
	/// let dt = Utc.with_ymd_and_hms(2025, 1, 15, 14, 30, 45).unwrap();
