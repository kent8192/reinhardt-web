...
## [0.4.0-alpha.16](https://github.com/kent8192/reinhardt-web/compare/reinhardt-utils@v0.4.0-alpha.15...reinhardt-utils@v0.4.0-alpha.16) - 2026-09-23
...
- *(staticfiles)* define unified manifest and classification contract
- *(staticfiles)* prepare deterministic asset generations
- *(staticfiles)* atomically activate verified asset generations
...
- *(staticfiles)* require concrete manifest media types
