...
//!
//! ```rust
//! use reinhardt_utils_core::checks::{Check, CheckLevel, CheckMessage, CheckRegistry};
//!
//! struct MyCheck;
//!
...
impl CheckMessage {
	...
	///
	/// ```rust
	/// use reinhardt_utils_core::checks::CheckMessage;
	///
...
///
/// ```rust
/// use reinhardt_utils_core::checks::{Check, CheckMessage};
///
...
impl CheckRegistry {
	...
	///
	/// ```rust
	/// use reinhardt_utils_core::checks::CheckRegistry;
	///
