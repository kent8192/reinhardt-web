...
mod mongodb_tests {
    use bson::doc;
    use reinhardt_db_backends::backends::mongodb::{
    ...
    async fn test_insert_and_find() {
        ...
        let _ = backend.database().collection::<bson::Document>("users").drop().await;
    ...
    async fn test_aggregation() {
        ...
        // Clean up collection first
        let _ = backend.database().collection::<bson::Document>("orders").drop().await;
    ...
    async fn test_query_builder() {
        ...
        // Clean up collection first
        let _ = backend.database().collection::<bson::Document>("products").drop().await;
