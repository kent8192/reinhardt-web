...
impl QueryMetrics {
	...
	///
	/// ```
	/// use reinhardt_orm::instrumentation::QueryMetrics;
...
impl TransactionMetrics {
	...
	///
	/// ```
	/// use reinhardt_orm::instrumentation::TransactionMetrics;
	/// use std::time::Duration;
	///
...
impl Statistics {
	...
	///
	/// ```
	/// use reinhardt_orm::instrumentation::{Statistics, QueryMetrics};
	/// use std::time::Duration;
	///
	...
	///
	/// ```
	/// use reinhardt_orm::instrumentation::{Statistics, TransactionMetrics};
	/// use std::time::Duration;
	///
	/// let mut stats = Statistics::default();
	/// let metrics = TransactionMetrics::new(Duration::from_secs(1), 5, true);
...
impl Instrumentation {
	...
	///
	/// ```
	/// use reinhardt_orm::instrumentation::Instrumentation;
	///
	...
	///
	/// ```
	/// use reinhardt_orm::instrumentation::{Instrumentation, EventListener};
	/// use std::sync::Arc;
	/// use std::time::Duration;
	/// use async_trait::async_trait;
	///
