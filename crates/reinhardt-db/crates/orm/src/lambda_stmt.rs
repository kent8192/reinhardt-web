...
impl LambdaStmt {
	...
	///
	/// ```
	/// use reinhardt_orm::lambda_stmt::LambdaStmt;
	///
...
impl QueryCache {
	...
	///
	/// ```
	/// use reinhardt_orm::lambda_stmt::QueryCache;
	///
...
impl LambdaRegistry {
	...
	///
	/// ```
	/// use reinhardt_orm::lambda_stmt::LambdaRegistry;
	///
...
impl CacheStatistics {
	...
	///
	/// ```
	/// use reinhardt_orm::lambda_stmt::CacheStatistics;
	///
