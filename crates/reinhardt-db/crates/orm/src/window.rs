...
impl FrameType {
	...
	///
	/// ```
	/// use reinhardt_orm::window::FrameType;
	///
...
impl FrameBoundary {
	...
	///
	/// ```
	/// use reinhardt_orm::window::FrameBoundary;
	///
...
impl Frame {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{Frame, FrameBoundary};
	///
...
impl Window {
	...
	///
	/// ```
	/// use reinhardt_orm::window::Window;
	///
	...
	///
	/// ```
	/// use reinhardt_orm::window::{Window, Frame, FrameBoundary};
	///
	/// let frame = Frame::rows(
	///     FrameBoundary::UnboundedPreceding,
	///     Some(FrameBoundary::CurrentRow)
...
impl RowNumber {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{RowNumber, Window, WindowFunction};
	///
	/// let window = Window::new()
	///     .partition_by("department")
	///     .order_by("hire_date");
...
impl Rank {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{Rank, Window, WindowFunction};
	///
	/// let window = Window::new()
	///     .partition_by("department")
	///     .order_by("salary DESC");
...
impl DenseRank {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{DenseRank, Window, WindowFunction};
	///
...
impl NTile {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{NTile, Window, WindowFunction};
	///
...
impl Lead {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{Lead, Window, WindowFunction};
	///
...
impl Lag {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{Lag, Window, WindowFunction};
	///
	/// let window = Window::new().order_by("date");
...
impl FirstValue {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{FirstValue, Window, WindowFunction};
	///
	/// let window = Window::new()
	///     .partition_by("department")
	///     .order_by("salary DESC");
...
impl LastValue {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{LastValue, Window, WindowFunction};
	///
	/// let window = Window::new()
	///     .partition_by("department")
	///     .order_by("salary DESC");
...
impl NthValue {
	...
	///
	/// ```
	/// use reinhardt_orm::window::{NthValue, Window, WindowFunction};
	///
	/// let window = Window::new().order_by("salary DESC");
