...
impl LateralJoin {
    ...
    ///
    /// ```
    /// use reinhardt_orm::lateral_join::{LateralJoin, LateralJoinType};
    ///
...
impl LateralJoinBuilder {
    ...
    ///
    /// ```
    /// use reinhardt_orm::lateral_join::LateralJoinBuilder;
    ///
...
impl LateralJoins {
    ...
    ///
    /// ```
    /// use reinhardt_orm::lateral_join::LateralJoins;
    ///
