...
## [0.1.0-rc.9](https://github.com/kent8192/reinhardt-web/compare/reinhardt-db@v0.1.0-rc.8...reinhardt-db@v0.1.0-rc.9) - 2026-03-14
...
- *(db)* replace Box::leak with sqlx::raw_sql in contenttypes
- *(db)* replace Box::leak with owned Strings in migration operations
- *(db)* replace Box::leak with sqlx::raw_sql in transaction drivers
- *(db)* replace Box::leak with owned Strings in schema diff
- *(db)* reduce unnecessary allocations in schema diff and migration tests
