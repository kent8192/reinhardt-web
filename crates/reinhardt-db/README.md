...
```toml
[dependencies]
reinhardt-db = { version = "0.4.0-alpha.16", features = ["postgres", "orm", "migrations"] }
```
...
```toml
[dependencies]
reinhardt-db = { version = "0.4.0-alpha.16", features = ["pgvector"] }
...
```toml
[dependencies]
reinhardt = { package = "reinhardt-web", version = "0.4.0-alpha.16", features = ["db-pgvector"] }
```
