...
```toml
[dependencies]
reinhardt-db = { version = "0.4.0-alpha.17", features = ["postgres", "orm", "migrations"] }
```
...
```toml
[dependencies]
reinhardt-db = { version = "0.4.0-alpha.17", features = ["pgvector"] }
...
```toml
[dependencies]
reinhardt = { package = "reinhardt-web", version = "0.4.0-alpha.17", features = ["db-pgvector"] }
```
