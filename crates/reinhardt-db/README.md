...
```toml
[dependencies]
reinhardt-db = { version = "0.4.0-alpha.15", features = ["postgres", "orm", "migrations"] }
```
...
```toml
[dependencies]
reinhardt-db = { version = "0.4.0-alpha.15", features = ["pgvector"] }
...
```toml
[dependencies]
reinhardt = { package = "reinhardt-web", version = "0.4.0-alpha.15", features = ["db-pgvector"] }
```
