...
mod boundary_tests {
	...
	#[case("", "/static/")]
	#[case("f", "/static/f")]
	#[case("a.css", "/static/a.css")]
	#[case(&"a".repeat(100), &format!("/static/{}", "a".repeat(100)))]
	#[case(&"a".repeat(255), &format!("/static/{}", "a".repeat(255)))]
	#[case(&"a".repeat(4096), &format!("/static/{}", "a".repeat(4096)))]
	...
	#[rstest]
	#[case("file.css", "/static/file.css")]
	#[case("a/file.css", "/static/a/file.css")]
	#[case("a/b/file.css", "/static/a/b/file.css")]
	#[case("a/b/c/d/e/f/g/h/i/j/file.css", "/static/a/b/c/d/e/f/g/h/i/j/file.css")]
	...
	#[rstest]
	#[case("file.css", "/static/file.css")]
	#[case("file.css?v=1", "/static/file.css?v=1")]
	#[case("file.css?version=1234567890", "/static/file.css?version=1234567890")]
	#[case(
        &format!("file.css?v={}", "x".repeat(100)),
        &format!("/static/file.css?v={}", "x".repeat(100))
    )]
	...
	#[rstest]
	#[case("/", "file.css")]
	#[case("/static/", "file.css")]
	#[case(&format!("/{}/", "a".repeat(50)), "file.css")]
	#[case(&format!("https://{}/static/", "cdn.example.com".repeat(5)), "file.css")]
	...
	#[rstest]
	#[case("file.c", "/static/file.c")]
	#[case("file.css", "/static/file.css")]
	#[case(
        &format!("file.{}", "a".repeat(50)),
        &format!("/static/file.{}", "a".repeat(50))
    )]
