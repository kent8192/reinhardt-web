...
## [0.2.3](https://github.com/kent8192/reinhardt-web/compare/reinhardt-pages@v0.2.2...reinhardt-pages@v0.2.3) - 2026-06-27

### Fixed

- constrain WASM server_fn prefixes to same-origin paths
- harden WASM server_fn prefix sanitization
- *(macros)* avoid debug logging extractor errors

## [0.2.1](https://github.com/kent8192/reinhardt-web/compare/reinhardt-pages@v0.2.0...reinhardt-pages@v0.2.1) - 2026-06-23
