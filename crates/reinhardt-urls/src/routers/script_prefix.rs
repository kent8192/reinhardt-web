...
//!
//! ```rust
//! use reinhardt_urls::routers::script_prefix::{set_script_prefix, get_script_prefix, clear_script_prefix};
//!
...
///
/// ```rust
/// use reinhardt_urls::routers::script_prefix::set_script_prefix;
///
/// set_script_prefix("/myapp/");
/// ```
...
///
/// ```rust
/// use reinhardt_urls::routers::script_prefix::{set_script_prefix, get_script_prefix};
///
/// set_script_prefix("/myapp/");
/// assert_eq!(get_script_prefix(), "/myapp/");
/// ```
