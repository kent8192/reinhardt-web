...
pub struct DefaultRouter {
    ...
    reverser: crate::reverse::UrlReverser,
}
...
impl DefaultRouter {
    ...
    pub fn new() -> Self {
        Self {
            ...
            reverser: crate::reverse::UrlReverser::new(),
        }
    }
    ...
    /// ```
    pub fn reverser(&self) -> &crate::reverse::UrlReverser {
        &self.reverser
    }
    ...
    ) -> crate::reverse::ReverseResult<String> {
