...
///
/// ```rust,no_run
/// # use reinhardt_di::params::{HeaderNamed, Authorization, ContentType};
...
impl<N: HeaderName, T> HeaderNamed<N, T> {
	...
	///
	/// ```
	/// use reinhardt_di::params::{HeaderNamed, ContentType};
	///
	...
	///
	/// ```
	/// use reinhardt_di::params::{HeaderNamed, Authorization};
	///
