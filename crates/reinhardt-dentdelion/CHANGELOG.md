...
## [0.1.0-alpha.12](https://github.com/kent8192/reinhardt-web/compare/reinhardt-dentdelion@v0.1.0-alpha.11...reinhardt-dentdelion@v0.1.0-alpha.12) - 2026-02-19

### Fixed

- *(dentdelion)* add SQL validation for WASM plugin queries
- *(dentdelion)* remove unsafe Send/Sync impl from TsRuntime
