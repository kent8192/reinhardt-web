...
```toml
[dependencies]
reinhardt = { version = "0.4.0-alpha.17", features = ["dentdelion"] }
...
impl MyPlugin {
    pub fn new() -> Self {
        Self {
            metadata: PluginMetadata::builder("my-plugin", "0.4.0-alpha.17")
...
<!-- reinhardt-version-sync -->
```wit
package reinhardt:dentdelion@0.4.0-alpha.17;
