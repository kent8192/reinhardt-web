...
impl HealthCheckResult {
	...
	///
	/// ```
	/// use reinhardt_static::health::HealthCheckResult;
	///
...
impl HealthReport {
	...
	///
	/// ```
	/// use reinhardt_static::health::{HealthReport, HealthCheckResult};
	///
	/// let checks = vec![
...
pub trait HealthCheck: Send + Sync {
	...
	///
	/// ```
	/// use reinhardt_static::health::{HealthCheck, HealthCheckResult};
	/// use async_trait::async_trait;
	///
...
impl HealthCheckManager {
	...
	///
	/// ```
	/// use reinhardt_static::health::HealthCheckManager;
	///
