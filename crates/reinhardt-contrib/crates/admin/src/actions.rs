...
///
/// ```
/// use reinhardt_admin::DeleteSelectedAction;
///
...
impl ActionRegistry {
    ...
    pub fn get_action(&self, name: &str) -> AdminResult<dashmap::mapref::one::Ref<String, Box<dyn AdminAction>>> {
        self.actions
            .get(name)
            .ok_or_else(|| AdminError::InvalidAction(format!("Action '{}' not found", name)))
    }
...
mod tests {
    ...
    fn test_action_result_is_success() {
        ...
        assert!(ActionResult::PartialSuccess {
