...
//!
//! ```rust
//! use reinhardt_sessions::backends::{JwtSessionBackend, JwtConfig, SessionBackend};
...
///
/// ```rust
/// use reinhardt_sessions::backends::JwtConfig;
/// use jsonwebtoken::Algorithm;
///
        ...
        T: for<'de> Deserialize<'de>,
    {
        ...
        let token_data = decode::<SessionClaims>(token, &decoding_key, &validation)
            .map_err(|e| match e.kind() {
                jsonwebtoken::errors::ErrorKind::ExpiredSignature => JwtSessionError::TokenExpired,
