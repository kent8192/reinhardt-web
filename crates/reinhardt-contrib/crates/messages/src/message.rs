...
impl MessageConfig {
	...
	///
	/// ```
	/// use reinhardt_messages::MessageConfig;
	///
	/// let config = MessageConfig::new();
	/// assert_eq!(config.get_tag(reinhardt_messages::Level::Info), Some("info"));
	/// ```
	pub fn new() -> Self {
	...
	/// assert_eq!(config.get_tag(reinhardt_messages::Level::Custom(42)), Some("custom"));
	/// ```
	...
	/// let config = MessageConfig::new();
	/// assert_eq!(config.get_tag(reinhardt_messages::Level::Info), Some("info"));
	/// assert_eq!(config.get_tag(reinhardt_messages::Level::Custom(99)), None);
	/// ```
