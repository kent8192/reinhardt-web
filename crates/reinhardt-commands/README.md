...
```toml
[dependencies]
reinhardt = { version = "0.1.3", features = ["commands"] }
...
```bash
# Pre-release: --version is required. Once 0.1.3 stable ships, --version
...
```toml
[dependencies]
reinhardt = { version = "0.1.3", features = ["standard"] }
linkme = "0.3"
```
