...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.2", features = ["commands"] }
...
```bash
# Pre-release: --version is required. Once 0.2.0-rc.2 stable ships, --version
...
context.insert("version", "0.2.0-rc.2");
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.2", features = ["standard"] }
linkme = "0.3"
```
