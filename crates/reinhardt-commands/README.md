...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.3", features = ["commands"] }
...
```bash
# Pre-release: --version is required. Once 0.2.0-rc.3 stable ships, --version
...
context.insert("version", "0.2.0-rc.3");
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.3", features = ["standard"] }
linkme = "0.3"
```
