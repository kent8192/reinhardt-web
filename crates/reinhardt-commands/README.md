...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.1", features = ["commands"] }
...
```bash
# Pre-release: --version is required. Once 0.2.0-rc.1 stable ships, --version
...
context.insert("version", "0.2.0-rc.1");
...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.1", features = ["standard"] }
linkme = "0.3"
```
