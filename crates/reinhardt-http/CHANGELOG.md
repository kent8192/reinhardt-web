...
## [0.1.0-alpha.8](https://github.com/kent8192/reinhardt-web/compare/reinhardt-http@v0.1.0-alpha.7...reinhardt-http@v0.1.0-alpha.8) - 2026-02-19
...
- *(http)* prevent path traversal in file upload handling
