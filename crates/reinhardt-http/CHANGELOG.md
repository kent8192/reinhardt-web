...
## [0.1.0-rc.6](https://github.com/kent8192/reinhardt-web/compare/reinhardt-http@v0.1.0-rc.5...reinhardt-http@v0.1.0-rc.6) - 2026-03-09

### Documentation

- *(http)* add missing public API documentation
