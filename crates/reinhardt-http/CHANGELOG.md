...
## [0.4.0-alpha.1](https://github.com/kent8192/reinhardt-web/compare/reinhardt-http@v0.3.2...reinhardt-http@v0.4.0-alpha.1) - 2026-07-20
...
- *(http)* preserve PathParams iterator type

### Performance

- *(http)* reduce request allocation overhead
- *(http)* reduce router allocation hot path
