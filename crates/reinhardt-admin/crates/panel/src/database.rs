...
mod tests {
	...
	async fn test_list_with_condition_or_search(mock_connection: DatabaseConnection) {
		...
		let result = db
			.list_with_condition::<User>("users", Some(&search_condition), vec![], 0, 50)
			.await;
	...
	async fn test_list_with_condition_and_additional(mock_connection: DatabaseConnection) {
		...
		let result = db
			.list_with_condition::<User>("users", Some(&search_condition), additional, 0, 50)
			.await;
	...
	async fn test_list_with_condition_none(mock_connection: DatabaseConnection) {
		...
		let result = db
			.list_with_condition::<User>("users", None, vec![], 0, 50)
			.await;
