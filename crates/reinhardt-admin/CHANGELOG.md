...
## [0.1.0-rc.16](https://github.com/kent8192/reinhardt-web/compare/reinhardt-admin@v0.1.0-rc.15...reinhardt-admin@v0.1.0-rc.16) - 2026-03-31
...
- *(admin)* use existing open-props version for vendor asset download
