...
## [0.1.0-rc.16](https://github.com/kent8192/reinhardt-web/compare/reinhardt-admin@v0.1.0-rc.15...reinhardt-admin@v0.1.0-rc.16) - 2026-04-07
...
- *(ci)* add origin guard headers to E2E tests and fix AuthState doc link
- *(ci)* apply rustfmt and fix collapsible_if clippy lint after main merge
- *(ci)* resolve remaining CI failures after main merge
- *(test)* add non-staff DB user and fix e2e_pages Docker host resolution
