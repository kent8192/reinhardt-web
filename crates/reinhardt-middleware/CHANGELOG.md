...
## [0.1.0-rc.2](https://github.com/kent8192/reinhardt/compare/reinhardt-middleware@v0.1.0-rc.1...reinhardt-middleware@v0.1.0-rc.2) - 2026-03-01

### Fixed

- *(middleware)* escape HTML in flatpages to prevent stored XSS
