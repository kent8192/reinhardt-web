...
pub mod error;
pub mod history;
pub mod injectable_signal;
mod lifecycle_events;
mod middleware;
mod model_signals;
pub mod persistence;
pub mod profiler;
pub mod receiver_context;
...
pub use injectable_signal::InjectableSignal;
pub use middleware::{MiddlewareFn, SignalCall, SignalMiddleware, SignalSpy};
pub use receiver_context::ReceiverContext;
...
mod tests {
	...
	#[derive(Debug, Clone)]
	// Test fixture: Model for signal integration tests
	#[allow(dead_code)]
	struct TestModel {
		id: i32,
		name: String,
