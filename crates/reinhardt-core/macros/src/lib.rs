...
/// client or WebSocket routing would need to stub the missing modules.
/// These flags let the macro skip the unused lookups:
///
...
///
/// ```rust,ignore
/// // REST-only project — no stub client_router.rs / ws_urls.rs needed.
/// #[routes(server_only)]
/// pub fn routes() -> UnifiedRouter {
