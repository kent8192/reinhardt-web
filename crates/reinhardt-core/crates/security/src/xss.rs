...
///
/// ```
/// use reinhardt_security::xss::escape_html_attr;
///
...
///
/// ```
/// use reinhardt_security::xss::escape_javascript;
///
...
///
/// ```
/// use reinhardt_security::xss::escape_url;
///
...
///
/// ```
/// use reinhardt_security::xss::detect_xss_patterns;
///
...
///
/// ```
/// use reinhardt_security::xss::is_safe_url;
///
