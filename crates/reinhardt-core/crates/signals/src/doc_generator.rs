...
impl SignalDocGenerator {
    ...
    pub fn generate_markdown(&self) -> String {
        ...
        output.push_str("This document provides comprehensive documentation for all signals in the system.\n\n");
    ...
    fn generate_signal_markdown(&self, doc: &SignalDocumentation) -> String {
        ...
        if !doc.receivers.is_empty() {
            ...
            output.push_str("| Receiver | Description | Priority | Critical | Expected Duration |\n");
            output.push_str("|----------|-------------|----------|----------|------------------|\n");
    ...
    pub fn generate_html(&self) -> String {
        ...
        output.push_str("    h2 { color: #666; border-bottom: 2px solid #ddd; padding-bottom: 5px; }\n");
        ...
        output.push_str("    pre { background-color: #f5f5f5; padding: 10px; border-radius: 5px; }\n");
