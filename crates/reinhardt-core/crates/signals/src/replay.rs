...
//!
//! ```
//! use reinhardt_signals::replay::{SignalReplayer, ReplayConfig, ReplaySpeed};
//! use reinhardt_signals::persistence::{MemoryStore, PersistentSignal};
...
use crate::persistence::{SignalStore, StoredSignal};
...
///
/// ```
/// use reinhardt_signals::replay::ReplaySpeed;
///
...
///
/// ```
/// use reinhardt_signals::replay::{ReplayConfig, ReplaySpeed};
///
...
///
/// ```
/// use reinhardt_signals::replay::ReplayStats;
///
...
///
/// ```
/// use reinhardt_signals::replay::{SignalReplayer, ReplayConfig};
/// use reinhardt_signals::persistence::MemoryStore;
/// use reinhardt_signals::{Signal, SignalName};
/// use serde::{Deserialize, Serialize};
///
/// #[derive(Clone, Serialize, Deserialize)]
...
mod tests {
    use super::*;
    use crate::persistence::{MemoryStore, PersistentSignal};
    ...
    fn test_replay_speed_calculations() {
        ...
        assert_eq!(ReplaySpeed::Instant.calculate_delay(original), Duration::from_millis(0));
        assert_eq!(ReplaySpeed::Realtime.calculate_delay(original), original);
        assert_eq!(ReplaySpeed::Fast.calculate_delay(original), Duration::from_secs(1));
