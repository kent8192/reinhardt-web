...
## [0.1.0-alpha.13](https://github.com/kent8192/reinhardt-web/compare/reinhardt-views@v0.1.0-alpha.12...reinhardt-views@v0.1.0-alpha.13) - 2026-02-19

### Fixed

- *(views)* escape user input to prevent XSS
- *(core)* replace Box::leak with Arc to prevent memory leak
