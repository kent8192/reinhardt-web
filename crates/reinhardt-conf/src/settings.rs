...
pub struct Settings {
	...
	#[deprecated(
		since = "0.2.0",
		note = "Use `installed_apps!` macro with `ApplicationBuilder` instead. This field will be removed in a future version."
	)]
...
impl Settings {
	...
	/// }
	/// ```
	#[allow(deprecated)] // Internal: initializes deprecated `installed_apps` field for backwards compatibility
	...
	#[allow(deprecated)] // Internal: accesses deprecated `installed_apps` field
