...
```toml
[dependencies]
reinhardt = { version = "0.3.0-rc.7", features = ["conf"] }

# Or use a preset:
# reinhardt = { version = "0.3.0-rc.7", features = ["standard"] }  # Recommended
# reinhardt = { version = "0.3.0-rc.7", features = ["full"] }      # All features
```
...
```toml
# With async support
reinhardt = { version = "0.3.0-rc.7", features = ["conf", "async"] }

# With encryption
reinhardt = { version = "0.3.0-rc.7", features = ["conf", "encryption"] }

# With Vault integration
reinhardt = { version = "0.3.0-rc.7", features = ["conf", "vault"] }
```
