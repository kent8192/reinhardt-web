...
```toml
[dependencies]
reinhardt = { version = "0.1.0", features = ["conf"] }
...
```toml
# With async support
reinhardt = { version = "0.1.0", features = ["conf", "async"] }

# With encryption
reinhardt = { version = "0.1.0", features = ["conf", "encryption"] }

# With Vault integration
reinhardt = { version = "0.1.0", features = ["conf", "vault"] }
```
