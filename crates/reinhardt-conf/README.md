...
```toml
[dependencies]
reinhardt = { version = "0.2.0-rc.2", features = ["conf"] }
...
```toml
# With async support
reinhardt = { version = "0.2.0-rc.2", features = ["conf", "async"] }

# With encryption
reinhardt = { version = "0.2.0-rc.2", features = ["conf", "encryption"] }

# With Vault integration
reinhardt = { version = "0.2.0-rc.2", features = ["conf", "vault"] }
```
