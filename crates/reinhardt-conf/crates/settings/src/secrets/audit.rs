...
//!
//! ```rust
//! use reinhardt_settings::secrets::audit::{SecretAuditLogger, SecretAccessEvent};
...
///
/// ```rust
/// use reinhardt_settings::secrets::audit::SecretAccessEvent;
///
/// let event = SecretAccessEvent::new(
///     "api_key".to_string(),
...
///
/// ```rust
/// use reinhardt_settings::secrets::audit::SecretAccessFilter;
///
...
///
/// ```rust,no_run
/// use reinhardt_settings::secrets::audit::{SecretAuditBackend, SecretAccessEvent, SecretAccessFilter};
/// use std::sync::Mutex;
///
...
impl SecretAuditLogger {
    ...
    ///
    /// ```rust
    /// use reinhardt_settings::secrets::audit::SecretAuditLogger;
    /// use reinhardt_settings::secrets::audit::backends::MemorySecretAuditBackend;
    /// use std::sync::Arc;
    ///
    /// let backend = Arc::new(MemorySecretAuditBackend::new());
    ...
    ///
    /// ```rust
    /// use reinhardt_settings::secrets::audit::{SecretAuditLogger, SecretAccessFilter};
    /// use reinhardt_settings::secrets::audit::backends::MemorySecretAuditBackend;
    /// use std::sync::Arc;
    ///
    /// # async fn example() -> Result<(), String> {
