...
## [0.1.0-rc.6](https://github.com/kent8192/reinhardt-web/compare/reinhardt-query@v0.1.0-rc.5...reinhardt-query@v0.1.0-rc.6) - 2026-03-08

### Documentation

- *(query)* translate Japanese comment to English in select.rs
- *(query)* add missing public API documentation
