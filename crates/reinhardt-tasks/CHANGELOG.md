...
## [0.1.0-rc.6](https://github.com/kent8192/reinhardt-web/compare/reinhardt-tasks@v0.1.0-rc.5...reinhardt-tasks@v0.1.0-rc.6) - 2026-03-09

### Documentation

- *(tasks)* add missing public API documentation

### Fixed

- *(tasks)* remove unused import and suppress dead code warning
