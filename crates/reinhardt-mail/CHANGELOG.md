...
## [0.1.0-alpha.10](https://github.com/kent8192/reinhardt-web/compare/reinhardt-mail@v0.1.0-alpha.9...reinhardt-mail@v0.1.0-alpha.10) - 2026-02-18

### Fixed

- *(mail)* prevent email header injection via address validation
