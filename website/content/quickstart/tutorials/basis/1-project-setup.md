...
This tutorial uses the `0.4.0-alpha.17` Reinhardt generator.
...
reinhardt = { version = "0.4.0-alpha.17", package = "reinhardt-web", default-features = false, features = ["pages", "client-router"] }
...
reinhardt = { version = "0.4.0-alpha.17", package = "reinhardt-web", default-features = false, features = [
    "minimal",
    "pages",
    "client-router",
    "admin",
