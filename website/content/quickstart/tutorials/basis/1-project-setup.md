...
This tutorial uses the `0.3.0-rc.7` Reinhardt generator.
...
reinhardt = { version = "0.3.0-rc.7", package = "reinhardt-web", default-features = false, features = ["pages", "client-router"] }
...
reinhardt = { version = "0.3.0-rc.7", package = "reinhardt-web", default-features = false, features = [
    "minimal",
    "pages",
    "client-router",
    "admin",
