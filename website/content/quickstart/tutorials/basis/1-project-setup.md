...
This tutorial uses the `0.3.20` Reinhardt generator.
...
reinhardt = { version = "0.3.20", package = "reinhardt-web", default-features = false, features = ["pages", "client-router"] }
...
reinhardt = { version = "0.3.20", package = "reinhardt-web", default-features = false, features = [
    "minimal",
    "pages",
    "client-router",
    "admin",
