...
// Upstream note (AuthRefactoring): Consider implementing a dedicated struct, similar to
// `MergeTimeoutConfig`, that allows us to implement a custom merge logic for `impl Store`,
// enabling fold-style merging of `SigV4OperationSigningConfig`.
